...
export const validateMyRestaurantRequest = [
  ...
  body("estimatedDeliveryTime").isInt({min: 0}).withMessage("Delivery time must be a positive integer"),
  ...
  body("menuItems.*.price")
              .isFloat({min: 0})
              .withMessage("Menu items price is required and must be a positive"),
  handleValidationErrors            
]